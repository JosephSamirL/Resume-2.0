...
export type Experience = Document & {
  ...
  nameOfCompany?: Maybe<Scalars['String']>;
...
export type ExperienceFilter = {
  ...
  _type?: InputMaybe<StringFilter>;
  _updatedAt?: InputMaybe<DatetimeFilter>;
  currentlyWorking?: InputMaybe<BooleanFilter>;
...
export type RootQueryAllProfileArgs = {
  limit?: InputMaybe<Scalars['Int']>;
  offset?: InputMaybe<Scalars['Int']>;
  sort?: InputMaybe<Array<ProfileSorting>>;
...
export type AllProfilesQuery = { __typename?: 'RootQuery', allProfile: Array<{ __typename?: 'Profile', name?: string | null, email?: string | null, summary?: string | null, link?: Array<{ __typename?: 'Link', name?: string | null, url?: string | null } | null> | null }> };
...
export type AllExperiencesQuery = { __typename?: 'RootQuery', allExperience: Array<{ __typename?: 'Experience', nameOfCompany?: string | null, startDate?: any | null, endDate?: any | null, role?: string | null, responsibilities?: Array<string | null> | null }> };
...
export const AllExperiencesDocument = gql`
    query allExperiences($limit: Int) {
  allExperience(limit: $limit) {
    nameOfCompany
    startDate
    endDate
    role
...
/**
 * __useAllExperiencesQuery__
 *
 * To run a query within a React component, call `useAllExperiencesQuery` and pass it any options that fit your needs.
 * When your component renders, `useAllExperiencesQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useAllExperiencesQuery({
 *   variables: {
 *      limit: // value for 'limit'
 *   },
 * });
 */
export function useAllExperiencesQuery(baseOptions?: Apollo.QueryHookOptions<AllExperiencesQuery, AllExperiencesQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<AllExperiencesQuery, AllExperiencesQueryVariables>(AllExperiencesDocument, options);
      }
export function useAllExperiencesLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<AllExperiencesQuery, AllExperiencesQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<AllExperiencesQuery, AllExperiencesQueryVariables>(AllExperiencesDocument, options);
        }
export type AllExperiencesQueryHookResult = ReturnType<typeof useAllExperiencesQuery>;
export type AllExperiencesLazyQueryHookResult = ReturnType<typeof useAllExperiencesLazyQuery>;
export type AllExperiencesQueryResult = Apollo.QueryResult<AllExperiencesQuery, AllExperiencesQueryVariables>;